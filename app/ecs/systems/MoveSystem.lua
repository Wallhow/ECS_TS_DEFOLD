    ...
    return ecs.systems.create(
        ...
        {update = function(____, e, dt)
            for ____, entity in ipairs(e) do
                ...
                PositionComponent.y = PositionComponent.y + VelocityComponent.y / (is_diagonaled_move and 2 or 1)
                PositionComponent.x = PositionComponent.x + VelocityComponent.x / (is_diagonaled_move and 2 or 1)
            end
        end}
    )
end
