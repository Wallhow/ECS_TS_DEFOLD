...
/**@noSelf */
export interface TweensForNode {
    to<T extends GUIPropsAnimation>(duration: number, prop: T, value: GUIValuesPropsAnimations<T>, otherOpt?: GUIOtherOptions): TweensForNode;
    by<T extends GUIPropsAnimation>(duration: number, prop: T, value: GUIValuesPropsAnimations<T>, otherOpt?: GUIOtherOptions): TweensForNode;
    opacityTo(duration: number, opacity: number, otherOpt?: GUIOtherOptions): TweensForNode;
    opacityBy(duration: number, opacity: number, otherOpt?: GUIOtherOptions): TweensForNode;
    moveBy(duration: number, positionBy: { x?: number, y?: number }, otherOpt?: GUIOtherOptions): TweensForNode;
    moveTo(duration: number, positionBy: { x?: number, y?: number }, otherOpt?: GUIOtherOptions): TweensForNode;
    scaleTo(duration: number, scaleTo: { x?: number, y?: number }, otherOpt?: GUIOtherOptions): TweensForNode;
    call(func: () => void): TweensForNode;
    parallel(): TweensForNode;
    delay(duration: number): TweensForNode;
    start(isRemoveTweenOnEnd?: boolean): Coroutine | undefined;
    stop(descr: Coroutine);
}
...
export function _newTweensForNode(obj: GUI_NODE): TweensForNode {
    ...
    function to<T extends GUIPropsAnimation>(duration: number, prop: T, value: GUIValuesPropsAnimations<T>, otherOpt?: GUIOtherOptions): TweensForNode {
    ...
    function by<T extends GUIPropsAnimation>(duration: number, prop: T, value: GUIValuesPropsAnimations<T>, otherOpt?: GUIOtherOptions): TweensForNode {
        const getValueFun = () => {
    ...
    function opacityTo(duration: number, opacity: number, otherOpt?: GUIOtherOptions): TweensForNode {
        return to(duration, 'color.w', { w: opacity }, otherOpt);
    }
    function opacityBy(duration: number, opacity: number, otherOpt?: GUIOtherOptions): TweensForNode {
        return by(duration, 'color.w', { w: opacity }, otherOpt);
    }

    function moveBy(duration: number, positionBy: { x?: number, y?: number }, otherOpt?: GUIOtherOptions): TweensForNode {
    ...
    function moveTo(duration: number, positionTo: { x?: number, y?: number }, otherOpt?: GUIOtherOptions): TweensForNode {
    ...
    function scaleTo(duration: number, scaleBy: { x?: number, y?: number }, otherOpt?: GUIOtherOptions): TweensForNode {
