...
export const ECS = () => {
    ...
    function getEntitiesWithComponents<compID extends ComponentsIDs[number]>(ids: compID[]): EntityIDList {
    ...
    const thisECS = {
        addComponent, newEntity, getEntity, getEntitiesWithComponent, getEntitiesWithComponents,
        systems: { ...sm },
